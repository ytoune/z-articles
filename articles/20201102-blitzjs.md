---
title: "️Blitz.js で気をつけたいこと（脆弱性対策）"
emoji: "⚡"
type: "tech"
...
このようなコードを書いてしまわないようにするために気をつけたい点を書いていきます
...
```diff:app/articles/pages/articles/new.tsx への変更
- import { Link, useRouter, useMutation, BlitzPage } from "blitz"
...
```diff:app/articles/mutations/createArticle.ts への変更
  import { Ctx } from "blitz"
+ import db from "db"
- import db, { ArticleCreateArgs } from "db"
...
極端な例として例えば管理者専用ページとして下記のようなフォームを置いてもバレます
